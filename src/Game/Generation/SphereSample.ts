...
const sphereSample: VoxelSampleFunction = ([x, y, z], context) => {
    ...
    const s = noise3d((x + context.resolution * 4) / NOISE_SCALE / distance, (y + context.resolution * 4) / NOISE_SCALE / distance, (z + context.resolution * 4) / NOISE_SCALE / distance);
    return [
